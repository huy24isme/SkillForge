      ...
      <div className="min-h-screen bg-[#0B1C2D] text-white font-sans selection:bg-[#3AE7E1] selection:text-[#0B1C2D] overflow-x-hidden">
        ...
        >
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            >
              <Link to="/leadership/executive" className="hidden md:block text-sm font-medium text-slate-300 hover:text-white">
                Đăng nhập
              </Link>
            ...
            >
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Link to="/leadership/executive" className="flex items-center gap-2">
                    Xem Demo
                  </Link>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  icon: Target,
                  title: 'BSC Strategic Dashboard',
                  desc: 'CEO nắm bắt toàn bộ 4 góc độ: Tài chính, Khách hàng, Quy trình, Con người trong 30 giây.',
                  gradient: 'from-[#3AE7E1]/20 to-[#2563EB]/20',
                },
                {
                  icon: Zap,
                  title: 'AI Bottleneck Detector',
                  desc: 'Tự động phát hiện các điểm nghẽn trong quy trình vận hành đang làm chậm dòng tiền.',
                  gradient: 'from-[#2563EB]/20 to-[#9333EA]/20',
                },
                {
                  icon: Sparkles,
                  title: 'CEO AI Briefing',
                  desc: 'Bản tin sáng sớm dành riêng cho lãnh đạo, dự báo rủi ro khách hàng và đề xuất tối ưu ROI.',
        ...
        <section id="pricing" className="py-24 px-6 bg-[#0F253A] relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {[
                { name: 'BSC Basic', price: '$99', features: ['2 BSC Perspectives', 'Daily AI Briefing', 'Standard Support'] },
                { name: 'BSC Professional', price: '$299', features: ['Full 4 BSC Perspectives', 'Process Bottleneck Detector', 'BSC AI Chatbot', 'Priority Support'], popular: true },
                { name: 'BSC Enterprise', price: 'Custom', features: ['Unlimited BSC Nodes', 'Custom Strategic KPIs', 'Dedicated Strategy Expert', '24/7 SLA'] }
              ].map((plan, idx) => (
                <motion.div
                  key={idx}
